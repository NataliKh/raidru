...
const presetScenes = {"nekzali": [{"name": "Пулл — контроль Колодца", "note": "Босс ниже центра. РДД и хилы полукругом сверху. Все адды перехватываются до входа в Колодец душ.", "duration": 10, "tokens": [["boss", "БОСС", "boss", 50, 72], ["t1", "T1", "tank", 50, 82], ["t2", "T2", "tank", 43, 77], ["h1", "H1", "healer", 34, 32], ["h2", "H2", "healer", 50, 28], ["h3", "H3", "healer", 66, 32], ["m1", "M1", "melee", 46, 66], ["m2", "M2", "melee", 54, 66], ["r1", "R1", "ranged", 22, 47], ["r2", "R2", "ranged", 78, 47], ["r3", "R3", "ranged", 50, 40], ["well", "КОЛОДЕЦ", "marker", 50, 50], ["top", "★", "marker", 50, 12], ["left", "●", "marker", 16, 50], ["right", "◆", "marker", 84, 50]], "effects": [{"type": "zone", "x": 50, "y": 50, "w": 18, "h": 18, "rot": 0, "label": "Колодец душ"}, {"type": "line", "x": 50, "y": 60, "w": 66, "h": 4, "rot": 0, "label": "Рубеж перехвата аддов"}], "routes": {"r1": [{"x": 24, "y": 40}], "r2": [{"x": 76, "y": 40}], "r3": [{"x": 50, "y": 34}]}}, {"name": "1-я волна аддов", "note": "Ближние добирают босса, РДД заранее смещаются к входам аддов. Нельзя пропускать амани в центр.", "duration": 8, "tokens": [["boss", "БОСС", "boss", 50, 72], ["t1", "T1", "tank", 50, 82], ["t2", "T2", "tank", 44, 76], ["h1", "H1", "healer", 34, 31], ["h2", "H2", "healer", 50, 28], ["h3", "H3", "healer", 66, 31], ["m1", "M1", "melee", 46, 66], ["m2", "M2", "melee", 54, 66], ["r1", "R1", "ranged", 23, 58], ["r2", "R2", "ranged", 77, 58], ["r3", "R3", "ranged", 50, 37], ["addL", "АДД", "marker", 18, 60], ["addR", "АДД", "marker", 82, 60], ["well", "КОЛОДЕЦ", "marker", 50, 50]], "effects": [{"type": "zone", "x": 50, "y": 50, "w": 18, "h": 18, "rot": 0, "label": "Колодец душ"}, {"type": "arrow", "x": 28, "y": 58, "w": 18, "h": 5, "rot": 180, "label": "Замедлить / убить"}, {"type": "arrow", "x": 72, "y": 58, "w": 18, "h": 5, "rot": 0, "label": "Замедлить / убить"}], "routes": {"r1": [{"x": 22, "y": 53}], "r2": [{"x": 78, "y": 53}]}}, {"name": "Разрыв сущности — вынос", "note": "Три цели с дебаффом расходятся по меткам. Диспел / помощь только после выхода на край.", "duration": 10, "tokens": [["boss", "БОСС", "boss", 50, 70], ["t1", "T1", "tank", 50, 80], ["t2", "T2", "tank", 44, 76], ["h1", "H1", "healer", 44, 38], ["h2", "H2", "healer", 50, 36], ["h3", "H3", "healer", 56, 38], ["m1", "M1", "melee", 47, 65], ["m2", "M2", "melee", 53, 65], ["r1", "РАЗРЫВ", "ranged", 18, 22], ["r2", "РАЗРЫВ", "ranged", 82, 22], ["r3", "РЕЙД", "ranged", 50, 30], ["deb3", "РАЗРЫВ", "healer", 82, 78], ["well", "КОЛОДЕЦ", "marker", 50, 50]], "effects": [{"type": "arrow", "x": 35, "y": 38, "w": 36, "h": 6, "rot": 225, "label": "Левый вынос"}, {"type": "arrow", "x": 65, "y": 38, "w": 36, "h": 6, "rot": -45, "label": "Правый вынос"}, {"type": "arrow", "x": 68, "y": 54, "w": 34, "h": 6, "rot": 45, "label": "Нижний вынос"}, {"type": "zone", "x": 50, "y": 50, "w": 18, "h": 18, "rot": 0, "label": "Колодец душ"}], "routes": {"r1": [{"x": 30, "y": 28}], "r2": [{"x": 70, "y": 28}], "deb3": [{"x": 72, "y": 66}]}}, {"name": "Обстрел одержимости", "note": "Танк разворачивает механику вдоль длинной оси комнаты. Рейд смещается в безопасный полукруг над Колодцем.", "duration": 8, "tokens": [["boss", "БОСС", "boss", 50, 72], ["t1", "T1", "tank", 50, 84], ["t2", "T2", "tank", 42, 76], ["h1", "H1", "healer", 36, 28], ["h2", "H2", "healer", 50, 26], ["h3", "H3", "healer", 64, 28], ["m1", "M1", "melee", 46, 66], ["m2", "M2", "melee", 54, 66], ["r1", "R1", "ranged", 30, 38], ["r2", "R2", "ranged", 70, 38], ["r3", "R3", "ranged", 50, 34], ["well", "КОЛОДЕЦ", "marker", 50, 50]], "effects": [{"type": "cone", "x": 50, "y": 82, "w": 32, "h": 28, "rot": 180, "label": "Фронтал танка"}, {"type": "zone", "x": 50, "y": 50, "w": 18, "h": 18, "rot": 0, "label": "Колодец душ"}, {"type": "soak", "x": 50, "y": 33, "w": 26, "h": 18, "rot": 0, "label": "Безопасный сбор"}]}, {"name": "Переход — Голодный костёр", "note": "На 50% все заходят в Эхо. На Голодный костёр — полный сбор прямо у центра.", "duration": 10, "tokens": [["echo", "ЭХО", "boss", 50, 50], ["t1", "T1", "tank", 46, 61], ["t2", "T2", "tank", 54, 61], ["h1", "H1", "healer", 42, 56], ["h2", "H2", "healer", 50, 56], ["h3", "H3", "healer", 58, 56], ["m1", "M1", "melee", 46, 50], ["m2", "M2", "melee", 54, 50], ["r1", "R1", "ranged", 42, 44], ["r2", "R2", "ranged", 58, 44], ["r3", "R3", "ranged", 50, 40]], "effects": [{"type": "soak", "x": 50, "y": 52, "w": 30, "h": 30, "rot": 0, "label": "Голодный костёр — ВСЕ ВМЕСТЕ"}], "routes": {"r1": [{"x": 46, "y": 48}], "r2": [{"x": 54, "y": 48}], "r3": [{"x": 50, "y": 46}]}}, {"name": "Финал — героизм", "note": "После возврата босса рейд играет компактно над центром. Героизм и оставшиеся рейдовые КД — сразу в работу.", "duration": 12, "tokens": [["boss", "БОСС", "boss", 50, 62], ["t1", "T1", "tank", 50, 74], ["t2", "T2", "tank", 43, 69], ["h1", "H1", "healer", 38, 34], ["h2", "H2", "healer", 50, 32], ["h3", "H3", "healer", 62, 34], ["m1", "M1", "melee", 46, 56], ["m2", "M2", "melee", 54, 56], ["r1", "R1", "ranged", 34, 45], ["r2", "R2", "ranged", 66, 45], ["r3", "R3", "ranged", 50, 40], ["well", "КОЛОДЕЦ", "marker", 50, 50]], "effects": [{"type": "zone", "x": 50, "y": 50, "w": 24, "h": 24, "rot": 0, "label": "Усиленный урон от Колодца"}, {"type": "soak", "x": 50, "y": 40, "w": 36, "h": 18, "rot": 0, "label": "Компактный рейд"}, {"type": "arrow", "x": 50, "y": 44, "w": 34, "h": 5, "rot": 0, "label": "Героизм / дожим"}]}], "sentinels": [{"name": "Старт — две стабильные группы", "note": "Левая и правая стороны играют отдельно. Боссов нельзя сводить ближе к центру.", "duration": 10, "tokens": [["bossL", "Б1", "boss", 28, 48], ["bossR", "Б2", "boss", 72, 48], ["t1", "T1", "tank", 22, 55], ["t2", "T2", "tank", 78, 55], ["h1", "H1", "healer", 18, 35], ["h2", "H2", "healer", 82, 35], ["m1", "M1", "melee", 28, 58], ["m2", "M2", "melee", 72, 58], ["r1", "R1", "ranged", 14, 48], ["r2", "R2", "ranged", 86, 48], ["r3", "РОУМ", "ranged", 50, 22]], "effects": [{"type": "line", "x": 50, "y": 50, "w": 44, "h": 4, "rot": 0, "label": "Не пересекать середину"}, {"type": "zone", "x": 28, "y": 48, "w": 18, "h": 18, "rot": 0, "label": "Левая группа"}, {"type": "zone", "x": 72, "y": 48, "w": 18, "h": 18, "rot": 0, "label": "Правая группа"}]}, {"name": "Сгущение яда — слизень", "note": "Обе стороны быстро переводят фокус в слизня. Боссов не двигаем ближе.", "duration": 8, "tokens": [["bossL", "Б1", "boss", 28, 48], ["bossR", "Б2", "boss", 72, 48], ["t1", "T1", "tank", 22, 55], ["t2", "T2", "tank", 78, 55], ["h1", "H1", "healer", 18, 35], ["h2", "H2", "healer", 82, 35], ["m1", "M1", "melee", 34, 54], ["m2", "M2", "melee", 66, 54], ["r1", "R1", "ranged", 40, 48], ["r2", "R2", "ranged", 60, 48], ["slime", "СЛИЗЕНЬ", "marker", 50, 48]], "effects": [{"type": "arrow", "x": 40, "y": 48, "w": 18, "h": 5, "rot": 0, "label": "Свитч"}, {"type": "arrow", "x": 60, "y": 48, "w": 18, "h": 5, "rot": 180, "label": "Свитч"}, {"type": "line", "x": 50, "y": 50, "w": 44, "h": 4, "rot": 0, "label": "Боссов не сводить"}], "routes": {"m1": [{"x": 40, "y": 54}], "m2": [{"x": 60, "y": 54}]}}, {"name": "Спиральные токсины — мини-группы", "note": "Игроки с токсинами сходятся по заранее назначенным парам, затем расходятся назад на свои стороны.", "duration": 10, "tokens": [["bossL", "Б1", "boss", 28, 48], ["bossR", "Б2", "boss", 72, 48], ["t1", "T1", "tank", 22, 56], ["t2", "T2", "tank", 78, 56], ["h1", "H1", "healer", 38, 42], ["h2", "H2", "healer", 62, 42], ["m1", "M1", "melee", 42, 58], ["m2", "M2", "melee", 58, 58], ["r1", "R1", "ranged", 42, 32], ["r2", "R2", "ranged", 58, 32], ["pair", "ТОКСИНЫ", "marker", 50, 44]], "effects": [{"type": "soak", "x": 50, "y": 44, "w": 24, "h": 24, "rot": 0, "label": "Назначенные пары / тройки"}, {"type": "line", "x": 50, "y": 50, "w": 44, "h": 4, "rot": 0, "label": "После очистки назад на стороны"}], "routes": {"h1": [{"x": 44, "y": 42}], "h2": [{"x": 56, "y": 42}], "r1": [{"x": 46, "y": 36}], "r2": [{"x": 54, "y": 36}]}}, {"name": "Интермиссия — стазис", "note": "В момент интермиссии рейд собирается ближе к центру, но сохраняет разделение боссов. ХП целей держим ровно.", "duration": 10, "tokens": [["bossL", "Б1", "boss", 36, 50], ["bossR", "Б2", "boss", 64, 50], ["t1", "T1", "tank", 32, 58], ["t2", "T2", "tank", 68, 58], ["h1", "H1", "healer", 42, 36], ["h2", "H2", "healer", 58, 36], ["m1", "M1", "melee", 42, 54], ["m2", "M2", "melee", 58, 54], ["r1", "R1", "ranged", 44, 26], ["r2", "R2", "ranged", 56, 26]], "effects": [{"type": "soak", "x": 50, "y": 44, "w": 30, "h": 22, "rot": 0, "label": "Общий сбор"}, {"type": "line", "x": 50, "y": 50, "w": 18, "h": 4, "rot": 0, "label": "Не сближать слишком рано"}]}, {"name": "Повтор цикла — слизень + токсины", "note": "После интермиссии возвращаемся к исходной геометрии. Сначала свитч в слизня, затем токсиновые пары.", "duration": 12, "tokens": [["bossL", "Б1", "boss", 28, 48], ["bossR", "Б2", "boss", 72, 48], ["t1", "T1", "tank", 22, 55], ["t2", "T2", "tank", 78, 55], ["h1", "H1", "healer", 18, 35], ["h2", "H2", "healer", 82, 35], ["m1", "M1", "melee", 34, 54], ["m2", "M2", "melee", 66, 54], ["r1", "R1", "ranged", 40, 48], ["r2", "R2", "ranged", 60, 48], ["slime", "СЛИЗЕНЬ", "marker", 50, 48], ["pair", "ПАРЫ", "marker", 50, 34]], "effects": [{"type": "arrow", "x": 40, "y": 48, "w": 18, "h": 5, "rot": 0, "label": "Свитч"}, {"type": "arrow", "x": 60, "y": 48, "w": 18, "h": 5, "rot": 180, "label": "Свитч"}, {"type": "soak", "x": 50, "y": 34, "w": 24, "h": 18, "rot": 0, "label": "Пары на токсинах"}]}, {"name": "Поздний цикл — аккуратный дожим", "note": "Урон уже высокий. Сохраняем исходное разделение, мини-группы на токсины заранее готовы.", "duration": 12, "tokens": [["bossL", "Б1", "boss", 28, 48], ["bossR", "Б2", "boss", 72, 48], ["t1", "T1", "tank", 22, 55], ["t2", "T2", "tank", 78, 55], ["h1", "H1", "healer", 18, 35], ["h2", "H2", "healer", 82, 35], ["m1", "M1", "melee", 28, 58], ["m2", "M2", "melee", 72, 58], ["r1", "R1", "ranged", 14, 48], ["r2", "R2", "ranged", 86, 48], ["r3", "КД", "ranged", 50, 22]], "effects": [{"type": "line", "x": 50, "y": 50, "w": 44, "h": 4, "rot": 0, "label": "Строго держать расстояние"}, {"type": "zone", "x": 50, "y": 24, "w": 18, "h": 12, "rot": 0, "label": "Рейд-КД / внешние"}]}], "vashnik": [{"name": "Старт — южный источник", "note": "Пулл у нижней грани. Рейд играет компактно позади босса, не заходя в центр источников.", "duration": 10, "tokens": [["boss", "БОСС", "boss", 50, 77], ["t1", "T1", "tank", 50, 86], ["t2", "T2", "tank", 42, 82], ["h1", "H1", "healer", 36, 58], ["h2", "H2", "healer", 50, 56], ["h3", "H3", "healer", 64, 58], ["m1", "M1", "melee", 46, 72], ["m2", "M2", "melee", 54, 72], ["r1", "R1", "ranged", 34, 67], ["r2", "R2", "ranged", 66, 67], ["r3", "R3", "ranged", 50, 64], ["srcA", "А", "marker", 50, 18], ["srcB", "Б", "marker", 24, 73], ["srcC", "В", "marker", 76, 73]], "effects": [{"type": "line", "x": 50, "y": 48, "w": 52, "h": 4, "rot": -90, "label": "Маршрут босса"}, {"type": "zone", "x": 50, "y": 18, "w": 12, "h": 12, "rot": 0, "label": "Источник А"}, {"type": "zone", "x": 24, "y": 73, "w": 12, "h": 12, "rot": 0, "label": "Источник Б"}, {"type": "zone", "x": 76, "y": 73, "w": 12, "h": 12, "rot": 0, "label": "Источник В"}]}, {"name": "Поглощение 1 — источник А + Б", "note": "Танк ведёт босса по левому ребру треугольника. РДД и хилы держатся во внутренней нижней дуге.", "duration": 10, "tokens": [["boss", "БОСС", "boss", 34, 60], ["t1", "T1", "tank", 28, 67], ["t2", "T2", "tank", 41, 65], ["h1", "H1", "healer", 44, 74], ["h2", "H2", "healer", 54, 72], ["h3", "H3", "healer", 62, 68], ["m1", "M1", "melee", 34, 66], ["m2", "M2", "melee", 40, 61], ["r1", "R1", "ranged", 48, 82], ["r2", "R2", "ranged", 60, 80], ["r3", "R3", "ranged", 72, 75], ["srcA", "А", "marker", 50, 18], ["srcB", "Б", "marker", 24, 73], ["srcC", "В", "marker", 76, 73]], "effects": [{"type": "arrow", "x": 38, "y": 55, "w": 44, "h": 6, "rot": -120, "label": "Маршрут к источнику А"}, {"type": "zone", "x": 34, "y": 60, "w": 20, "h": 20, "rot": 0, "label": "Поглощение"}, {"type": "line", "x": 52, "y": 78, "w": 30, "h": 4, "rot": 0, "label": "РДД вне пути аддов"}], "routes": {"r1": [{"x": 42, "y": 76}], "r2": [{"x": 54, "y": 76}], "r3": [{"x": 66, "y": 74}]}}, {"name": "Живые яды — перехват аддов", "note": "Адды выходят с активированного ребра. РДД свитчат, мили остаются на боссе только при отсутствии угрозы центру.", "duration": 8, "tokens": [["boss", "БОСС", "boss", 34, 60], ["t1", "T1", "tank", 28, 67], ["t2", "T2", "tank", 41, 65], ["h1", "H1", "healer", 44, 74], ["h2", "H2", "healer", 54, 72], ["h3", "H3", "healer", 62, 68], ["m1", "M1", "melee", 34, 66], ["m2", "M2", "melee", 40, 61], ["r1", "R1", "ranged", 48, 82], ["r2", "R2", "ranged", 60, 80], ["r3", "R3", "ranged", 72, 75], ["add1", "АДД", "marker", 54, 46], ["add2", "АДД", "marker", 62, 34]], "effects": [{"type": "arrow", "x": 54, "y": 46, "w": 20, "h": 5, "rot": -45, "label": "Свитч в адда"}, {"type": "arrow", "x": 62, "y": 34, "w": 22, "h": 5, "rot": -45, "label": "Свитч в адда"}, {"type": "line", "x": 54, "y": 55, "w": 24, "h": 4, "rot": -45, "label": "Не пропустить к центру"}]}, {"name": "Поглощение 2 — источник А + В", "note": "Следующий маршрут — через правое ребро. Рейд перекатывается в левую нижнюю зону, освобождая путь танку.", "duration": 10, "tokens": [["boss", "БОСС", "boss", 66, 60], ["t1", "T1", "tank", 72, 67], ["t2", "T2", "tank", 59, 65], ["h1", "H1", "healer", 38, 68], ["h2", "H2", "healer", 46, 72], ["h3", "H3", "healer", 56, 74], ["m1", "M1", "melee", 60, 61], ["m2", "M2", "melee", 66, 66], ["r1", "R1", "ranged", 28, 75], ["r2", "R2", "ranged", 40, 80], ["r3", "R3", "ranged", 52, 82], ["srcA", "А", "marker", 50, 18], ["srcB", "Б", "marker", 24, 73], ["srcC", "В", "marker", 76, 73]], "effects": [{"type": "arrow", "x": 62, "y": 55, "w": 44, "h": 6, "rot": 120, "label": "Маршрут к источнику А/В"}, {"type": "zone", "x": 66, "y": 60, "w": 20, "h": 20, "rot": 0, "label": "Поглощение"}, {"type": "line", "x": 42, "y": 78, "w": 30, "h": 4, "rot": 0, "label": "РДД и хилы здесь"}], "routes": {"r1": [{"x": 34, "y": 76}], "r2": [{"x": 44, "y": 78}], "r3": [{"x": 52, "y": 78}]}}, {"name": "Сифонная инфекция — хил-КД", "note": "Рейд играет компактнее, чтобы хилы накрывали поглощение. Используются назначенные внешние и первые крупные рейд-КД.", "duration": 10, "tokens": [["boss", "БОСС", "boss", 66, 60], ["t1", "T1", "tank", 72, 67], ["t2", "T2", "tank", 59, 65], ["h1", "H1", "healer", 44, 70], ["h2", "H2", "healer", 50, 68], ["h3", "H3", "healer", 56, 70], ["m1", "M1", "melee", 60, 61], ["m2", "M2", "melee", 66, 66], ["r1", "R1", "ranged", 42, 78], ["r2", "R2", "ranged", 50, 78], ["r3", "R3", "ranged", 58, 78]], "effects": [{"type": "soak", "x": 50, "y": 74, "w": 28, "h": 18, "rot": 0, "label": "Компактный рейд"}, {"type": "zone", "x": 66, "y": 60, "w": 20, "h": 20, "rot": 0, "label": "Опасный цикл"}]}, {"name": "Поздний цикл — дожим", "note": "Танк снова возвращает босса вниз. Арена чище, но входящий урон выше — добиваем под бурст и хил-КД.", "duration": 12, "tokens": [["boss", "БОСС", "boss", 50, 76], ["t1", "T1", "tank", 50, 86], ["t2", "T2", "tank", 42, 82], ["h1", "H1", "healer", 36, 60], ["h2", "H2", "healer", 50, 58], ["h3", "H3", "healer", 64, 60], ["m1", "M1", "melee", 46, 71], ["m2", "M2", "melee", 54, 71], ["r1", "R1", "ranged", 34, 68], ["r2", "R2", "ranged", 66, 68], ["r3", "R3", "ranged", 50, 64]], "effects": [{"type": "line", "x": 50, "y": 48, "w": 54, "h": 4, "rot": -90, "label": "Повторный маршрут"}, {"type": "zone", "x": 50, "y": 58, "w": 30, "h": 16, "rot": 0, "label": "Рейд здесь"}, {"type": "arrow", "x": 50, "y": 66, "w": 22, "h": 5, "rot": 0, "label": "Дожим / бурст"}]}], "explorers": [{"name": "Старт — треугольник совета", "note": "Три цели стоят треугольником. Рейд бьёт кливом, но не допускает сильного перекоса по здоровью.", "duration": 10, "tokens": [["boss1", "Б1", "boss", 50, 22], ["boss2", "Б2", "boss", 28, 68], ["boss3", "Б3", "boss", 72, 68], ["t1", "T1", "tank", 46, 30], ["t2", "T2", "tank", 32, 60], ["h1", "H1", "healer", 50, 42], ["h2", "H2", "healer", 40, 52], ["h3", "H3", "healer", 60, 52], ["m1", "M1", "melee", 44, 50], ["m2", "M2", "melee", 56, 50], ["r1", "R1", "ranged", 22, 34], ["r2", "R2", "ranged", 78, 34], ["r3", "R3", "ranged", 50, 80]], "effects": [{"type": "line", "x": 50, "y": 52, "w": 42, "h": 4, "rot": 0, "label": "Клив по трём целям"}, {"type": "zone", "x": 50, "y": 52, "w": 22, "h": 22, "rot": 0, "label": "Центр рейда"}]}, {"name": "Могучий удар — общий soak", "note": "Когда начинается Могучий удар, весь рейд быстро собирается в центр комнаты.", "duration": 8, "tokens": [["boss1", "Б1", "boss", 50, 24], ["boss2", "Б2", "boss", 30, 68], ["boss3", "Б3", "boss", 70, 68], ["t1", "T1", "tank", 46, 34], ["t2", "T2", "tank", 54, 34], ["h1", "H1", "healer", 44, 46], ["h2", "H2", "healer", 50, 46], ["h3", "H3", "healer", 56, 46], ["m1", "M1", "melee", 46, 54], ["m2", "M2", "melee", 54, 54], ["r1", "R1", "ranged", 44, 62], ["r2", "R2", "ranged", 56, 62], ["r3", "R3", "ranged", 50, 66]], "effects": [{"type": "soak", "x": 50, "y": 54, "w": 30, "h": 30, "rot": 0, "label": "Могучий удар — ВСЕ"}, {"type": "arrow", "x": 50, "y": 64, "w": 20, "h": 5, "rot": 180, "label": "Собраться"}], "routes": {"r1": [{"x": 34, "y": 52}], "r2": [{"x": 66, "y": 52}], "r3": [{"x": 50, "y": 72}]}}, {"name": "Последнее вознесение — рыба A", "note": "Назначенный носитель первой рыбы идёт к цели Вознесения и сбивает каст. Остальные держат треугольник босса.", "duration": 10, "tokens": [["boss1", "Б1", "boss", 50, 22], ["boss2", "Б2", "boss", 28, 68], ["boss3", "Б3", "boss", 72, 68], ["t1", "T1", "tank", 46, 30], ["t2", "T2", "tank", 32, 60], ["h1", "H1", "healer", 50, 42], ["h2", "H2", "healer", 40, 52], ["h3", "H3", "healer", 60, 52], ["m1", "M1", "melee", 44, 50], ["m2", "M2", "melee", 56, 50], ["r1", "РЫБА A", "ranged", 20, 36], ["r2", "R2", "ranged", 78, 34], ["r3", "R3", "ranged", 50, 80], ["cast", "ВОЗНЕСЕНИЕ", "marker", 72, 52]], "effects": [{"type": "arrow", "x": 26, "y": 40, "w": 54, "h": 6, "rot": 25, "label": "Носитель рыбы идёт сюда"}, {"type": "line", "x": 50, "y": 52, "w": 42, "h": 4, "rot": 0, "label": "Остальные держат центр"}], "routes": {"r1": [{"x": 34, "y": 38}, {"x": 50, "y": 42}, {"x": 64, "y": 48}]}}, {"name": "Огонь / лёд — разведение", "note": "Игроки с эффектами отходят в боковые сектора, не ломая центр и не перекрывая путь рыбе.", "duration": 8, "tokens": [["boss1", "Б1", "boss", 50, 22], ["boss2", "Б2", "boss", 28, 68], ["boss3", "Б3", "boss", 72, 68], ["t1", "T1", "tank", 46, 30], ["t2", "T2", "tank", 32, 60], ["h1", "H1", "healer", 40, 40], ["h2", "H2", "healer", 50, 48], ["h3", "H3", "healer", 60, 40], ["m1", "ОГОНЬ", "melee", 26, 50], ["m2", "ЛЁД", "melee", 74, 50], ["r1", "R1", "ranged", 24, 32], ["r2", "R2", "ranged", 76, 32], ["r3", "R3", "ranged", 50, 78]], "effects": [{"type": "zone", "x": 26, "y": 50, "w": 16, "h": 16, "rot": 0, "label": "Огонь"}, {"type": "zone", "x": 74, "y": 50, "w": 16, "h": 16, "rot": 0, "label": "Лёд"}, {"type": "soak", "x": 50, "y": 56, "w": 22, "h": 18, "rot": 0, "label": "Остальной рейд"}]}, {"name": "Последнее вознесение — рыба B/C", "note": "Следующие рыбы идут по очереди B → C. Рейд остаётся в центре и только чуть смещается для удобства носителя.", "duration": 10, "tokens": [["boss1", "Б1", "boss", 50, 22], ["boss2", "Б2", "boss", 28, 68], ["boss3", "Б3", "boss", 72, 68], ["t1", "T1", "tank", 46, 30], ["t2", "T2", "tank", 32, 60], ["h1", "H1", "healer", 50, 44], ["h2", "H2", "healer", 40, 54], ["h3", "H3", "healer", 60, 54], ["m1", "M1", "melee", 44, 50], ["m2", "M2", "melee", 56, 50], ["r1", "РЫБА B", "ranged", 80, 36], ["r2", "R2", "ranged", 50, 80], ["r3", "РЫБА C", "ranged", 20, 36], ["cast", "ВОЗНЕСЕНИЕ", "marker", 50, 52]], "effects": [{"type": "arrow", "x": 74, "y": 40, "w": 38, "h": 6, "rot": 155, "label": "Рыба B"}, {"type": "arrow", "x": 26, "y": 40, "w": 38, "h": 6, "rot": 25, "label": "Рыба C"}, {"type": "soak", "x": 50, "y": 54, "w": 26, "h": 22, "rot": 0, "label": "Рейд в центре"}], "routes": {"r1": [{"x": 66, "y": 42}, {"x": 56, "y": 48}], "r3": [{"x": 34, "y": 42}, {"x": 44, "y": 48}]}}, {"name": "Поздний дожим — выравнивание HP", "note": "Три цели выровнены, рейд снова играет треугольник. Дожимаем без перекоса по процентам.", "duration": 12, "tokens": [["boss1", "Б1", "boss", 50, 22], ["boss2", "Б2", "boss", 28, 68], ["boss3", "Б3", "boss", 72, 68], ["t1", "T1", "tank", 46, 30], ["t2", "T2", "tank", 32, 60], ["h1", "H1", "healer", 50, 42], ["h2", "H2", "healer", 40, 52], ["h3", "H3", "healer", 60, 52], ["m1", "M1", "melee", 44, 50], ["m2", "M2", "melee", 56, 50], ["r1", "R1", "ranged", 22, 34], ["r2", "R2", "ranged", 78, 34], ["r3", "R3", "ranged", 50, 80]], "effects": [{"type": "line", "x": 50, "y": 52, "w": 42, "h": 4, "rot": 0, "label": "Клив по трём целям"}, {"type": "zone", "x": 50, "y": 52, "w": 22, "h": 22, "rot": 0, "label": "Баланс HP"}]}], "sszorak": [{"name": "Старт — играем по центру", "note": "Босс в центре. РДД и хилы веером внизу, чтобы видеть направление следующего ветра.", "duration": 10, "tokens": [["boss", "БОСС", "boss", 50, 42], ["t1", "T1", "tank", 50, 54], ["t2", "T2", "tank", 42, 50], ["h1", "H1", "healer", 36, 72], ["h2", "H2", "healer", 50, 76], ["h3", "H3", "healer", 64, 72], ["m1", "M1", "melee", 46, 48], ["m2", "M2", "melee", 54, 48], ["r1", "R1", "ranged", 30, 62], ["r2", "R2", "ranged", 70, 62], ["r3", "R3", "ranged", 50, 62]], "effects": [{"type": "zone", "x": 50, "y": 42, "w": 24, "h": 24, "rot": 0, "label": "Босс / старт"}, {"type": "line", "x": 50, "y": 62, "w": 40, "h": 4, "rot": 0, "label": "РДД и хилы"}]}, {"name": "Воющий вихрь — ветер вверх", "note": "На ветер весь рейд заранее смещается вниз, чтобы его вытолкнуло в безопасную середину, а не в край.", "duration": 9, "tokens": [["boss", "БОСС", "boss", 50, 38], ["t1", "T1", "tank", 50, 50], ["t2", "T2", "tank", 42, 46], ["h1", "H1", "healer", 36, 82], ["h2", "H2", "healer", 50, 84], ["h3", "H3", "healer", 64, 82], ["m1", "M1", "melee", 46, 46], ["m2", "M2", "melee", 54, 46], ["r1", "R1", "ranged", 34, 74], ["r2", "R2", "ranged", 66, 74], ["r3", "R3", "ranged", 50, 72]], "effects": [{"type": "arrow", "x": 50, "y": 54, "w": 70, "h": 7, "rot": -90, "label": "Направление ветра"}, {"type": "zone", "x": 50, "y": 82, "w": 30, "h": 14, "rot": 0, "label": "Стартовая позиция перед сдувом"}]}, {"name": "Ядовитый выброс — чистим края", "note": "Опасные зоны складываются по внешнему кругу. Центр платформы оставляем чистым.", "duration": 9, "tokens": [["boss", "БОСС", "boss", 50, 42], ["t1", "T1", "tank", 50, 54], ["t2", "T2", "tank", 42, 50], ["h1", "H1", "healer", 36, 72], ["h2", "H2", "healer", 50, 76], ["h3", "H3", "healer", 64, 72], ["m1", "M1", "melee", 46, 48], ["m2", "M2", "melee", 54, 48], ["r1", "R1", "ranged", 20, 24], ["r2", "R2", "ranged", 80, 24], ["r3", "R3", "ranged", 50, 86]], "effects": [{"type": "zone", "x": 22, "y": 24, "w": 16, "h": 16, "rot": 0, "label": "Лужа"}, {"type": "zone", "x": 78, "y": 24, "w": 16, "h": 16, "rot": 0, "label": "Лужа"}, {"type": "zone", "x": 50, "y": 86, "w": 16, "h": 12, "rot": 0, "label": "Лужа"}, {"type": "soak", "x": 50, "y": 64, "w": 30, "h": 12, "rot": 0, "label": "Чистый центр"}], "routes": {"r1": [{"x": 24, "y": 34}], "r2": [{"x": 76, "y": 34}], "r3": [{"x": 50, "y": 78}]}}, {"name": "Высший хищник — танк сейв", "note": "Танки выносят тяжёлые удары ближе к центру, хилы уплотняются для быстрого подъёма.", "duration": 8, "tokens": [["boss", "БОСС", "boss", 50, 42], ["t1", "T1", "tank", 50, 55], ["t2", "T2", "tank", 44, 50], ["h1", "H1", "healer", 42, 70], ["h2", "H2", "healer", 50, 72], ["h3", "H3", "healer", 58, 70], ["m1", "M1", "melee", 46, 48], ["m2", "M2", "melee", 54, 48], ["r1", "R1", "ranged", 38, 62], ["r2", "R2", "ranged", 62, 62], ["r3", "R3", "ranged", 50, 62]], "effects": [{"type": "cone", "x": 50, "y": 52, "w": 26, "h": 20, "rot": 180, "label": "Тяжёлый танковый урон"}, {"type": "soak", "x": 50, "y": 68, "w": 26, "h": 16, "rot": 0, "label": "Хилы компактно"}]}, {"name": "Зарыться — бурст окно", "note": "Когда босс уязвим, рейд возвращается в центр. Все дпс-КД и, при желании, Героизм идут сюда.", "duration": 10, "tokens": [["boss", "БОСС", "boss", 50, 42], ["t1", "T1", "tank", 50, 54], ["t2", "T2", "tank", 42, 50], ["h1", "H1", "healer", 40, 68], ["h2", "H2", "healer", 50, 70], ["h3", "H3", "healer", 60, 68], ["m1", "M1", "melee", 46, 48], ["m2", "M2", "melee", 54, 48], ["r1", "R1", "ranged", 38, 60], ["r2", "R2", "ranged", 62, 60], ["r3", "R3", "ranged", 50, 58]], "effects": [{"type": "zone", "x": 50, "y": 42, "w": 26, "h": 26, "rot": 0, "label": "Окно повышенного урона"}, {"type": "arrow", "x": 50, "y": 58, "w": 20, "h": 5, "rot": 180, "label": "Бурст / Героизм"}]}, {"name": "Поздний ветер — дожим", "note": "В конце боя платформа частично занята зонами. Рейд играет в одном безопасном секторе и добивает босса.", "duration": 12, "tokens": [["boss", "БОСС", "boss", 54, 44], ["t1", "T1", "tank", 54, 56], ["t2", "T2", "tank", 46, 52], ["h1", "H1", "healer", 34, 74], ["h2", "H2", "healer", 46, 76], ["h3", "H3", "healer", 58, 74], ["m1", "M1", "melee", 50, 48], ["m2", "M2", "melee", 58, 48], ["r1", "R1", "ranged", 28, 66], ["r2", "R2", "ranged", 42, 66], ["r3", "R3", "ranged", 56, 64]], "effects": [{"type": "zone", "x": 76, "y": 24, "w": 18, "h": 18, "rot": 0, "label": "Опасная зона"}, {"type": "zone", "x": 22, "y": 84, "w": 18, "h": 12, "rot": 0, "label": "Опасная зона"}, {"type": "arrow", "x": 50, "y": 60, "w": 56, "h": 7, "rot": 20, "label": "Следить за ветром / дожим"}]}], "fangs": [{"name": "Старт — игра в центре", "note": "Два босса контролируются в центре арены. Рейд расставлен полукругом снизу, чтобы забирать капли по команде.", "duration": 10, "tokens": [["boss1", "КЛЫК 1", "boss", 44, 34], ["boss2", "КЛЫК 2", "boss", 56, 34], ["t1", "T1", "tank", 44, 46], ["t2", "T2", "tank", 56, 46], ["h1", "H1", "healer", 36, 72], ["h2", "H2", "healer", 50, 76], ["h3", "H3", "healer", 64, 72], ["m1", "M1", "melee", 44, 40], ["m2", "M2", "melee", 56, 40], ["r1", "R1", "ranged", 30, 60], ["r2", "R2", "ranged", 70, 60], ["r3", "R3", "ranged", 50, 60]], "effects": [{"type": "zone", "x": 50, "y": 34, "w": 24, "h": 18, "rot": 0, "label": "Позиция боссов"}, {"type": "line", "x": 50, "y": 60, "w": 46, "h": 4, "rot": 0, "label": "РДД / хилы"}]}, {"name": "Едкие капли — разбор сторон", "note": "Назначенные игроки берут капли слева и справа. Остальной рейд не ломает геометрию центра.", "duration": 9, "tokens": [["boss1", "КЛЫК 1", "boss", 44, 34], ["boss2", "КЛЫК 2", "boss", 56, 34], ["t1", "T1", "tank", 44, 46], ["t2", "T2", "tank", 56, 46], ["h1", "H1", "healer", 36, 72], ["h2", "H2", "healer", 50, 76], ["h3", "H3", "healer", 64, 72], ["m1", "M1", "melee", 44, 40], ["m2", "M2", "melee", 56, 40], ["r1", "КАПЛЯ", "ranged", 22, 54], ["r2", "КАПЛЯ", "ranged", 78, 54], ["r3", "R3", "ranged", 50, 60]], "effects": [{"type": "zone", "x": 22, "y": 54, "w": 14, "h": 14, "rot": 0, "label": "Капля"}, {"type": "zone", "x": 78, "y": 54, "w": 14, "h": 14, "rot": 0, "label": "Капля"}, {"type": "arrow", "x": 32, "y": 56, "w": 18, "h": 5, "rot": 180, "label": "Забрать"}, {"type": "arrow", "x": 68, "y": 56, "w": 18, "h": 5, "rot": 0, "label": "Забрать"}], "routes": {"r1": [{"x": 28, "y": 56}], "r2": [{"x": 72, "y": 56}]}}, {"name": "Ненасытная трапеза — очистка стаков", "note": "На Трапезу рейд быстро уходит в верхнюю зону и сбрасывает стаки Вечного яда.", "duration": 10, "tokens": [["boss1", "КЛЫК 1", "boss", 44, 34], ["boss2", "КЛЫК 2", "boss", 56, 34], ["t1", "T1", "tank", 44, 46], ["t2", "T2", "tank", 56, 46], ["h1", "H1", "healer", 40, 24], ["h2", "H2", "healer", 50, 24], ["h3", "H3", "healer", 60, 24], ["m1", "M1", "melee", 44, 28], ["m2", "M2", "melee", 56, 28], ["r1", "R1", "ranged", 42, 16], ["r2", "R2", "ranged", 58, 16], ["r3", "R3", "ranged", 50, 14]], "effects": [{"type": "soak", "x": 50, "y": 22, "w": 28, "h": 20, "rot": 0, "label": "Трапеза — очистка"}, {"type": "arrow", "x": 50, "y": 34, "w": 30, "h": 6, "rot": -90, "label": "Рейд уходит вверх"}], "routes": {"h1": [{"x": 40, "y": 56}, {"x": 40, "y": 34}], "h2": [{"x": 50, "y": 56}, {"x": 50, "y": 34}], "h3": [{"x": 60, "y": 56}, {"x": 60, "y": 34}]}}, {"name": "Отродья Вексхул — быстрый свитч", "note": "После очистки сразу переключаемся в аддов, не отдавая им свободное пространство.", "duration": 8, "tokens": [["boss1", "КЛЫК 1", "boss", 44, 34], ["boss2", "КЛЫК 2", "boss", 56, 34], ["t1", "T1", "tank", 44, 46], ["t2", "T2", "tank", 56, 46], ["h1", "H1", "healer", 36, 72], ["h2", "H2", "healer", 50, 76], ["h3", "H3", "healer", 64, 72], ["m1", "M1", "melee", 44, 40], ["m2", "M2", "melee", 56, 40], ["r1", "R1", "ranged", 30, 60], ["r2", "R2", "ranged", 70, 60], ["r3", "R3", "ranged", 50, 60], ["add1", "АДД", "marker", 34, 22], ["add2", "АДД", "marker", 66, 22]], "effects": [{"type": "arrow", "x": 40, "y": 28, "w": 16, "h": 5, "rot": -120, "label": "Свитч"}, {"type": "arrow", "x": 60, "y": 28, "w": 16, "h": 5, "rot": -60, "label": "Свитч"}]}, {"name": "Поздний цикл — высокие стаки", "note": "Игроки с высокими стаками заранее готовятся к следующей Трапезе, хилы держат их в приоритете.", "duration": 10, "tokens": [["boss1", "КЛЫК 1", "boss", 46, 36], ["boss2", "КЛЫК 2", "boss", 58, 36], ["t1", "T1", "tank", 46, 48], ["t2", "T2", "tank", 58, 48], ["h1", "H1", "healer", 36, 74], ["h2", "H2", "healer", 50, 78], ["h3", "H3", "healer", 64, 74], ["m1", "M1", "melee", 46, 42], ["m2", "M2", "melee", 58, 42], ["r1", "6", "ranged", 30, 62], ["r2", "7", "ranged", 70, 62], ["r3", "5", "ranged", 50, 62]], "effects": [{"type": "zone", "x": 50, "y": 62, "w": 34, "h": 12, "rot": 0, "label": "Высокие стаки — приоритет"}, {"type": "line", "x": 50, "y": 30, "w": 28, "h": 4, "rot": 0, "label": "Боссов держать стабильно"}]}, {"name": "Финальный дожим", "note": "Последняя Трапеза и последний набор капель уже не ломают план. Добиваем под бурст и внешние сейвы.", "duration": 12, "tokens": [["boss1", "КЛЫК 1", "boss", 46, 36], ["boss2", "КЛЫК 2", "boss", 58, 36], ["t1", "T1", "tank", 46, 48], ["t2", "T2", "tank", 58, 48], ["h1", "H1", "healer", 40, 68], ["h2", "H2", "healer", 50, 70], ["h3", "H3", "healer", 60, 68], ["m1", "M1", "melee", 46, 42], ["m2", "M2", "melee", 58, 42], ["r1", "R1", "ranged", 38, 58], ["r2", "R2", "ranged", 62, 58], ["r3", "R3", "ranged", 50, 58]], "effects": [{"type": "soak", "x": 50, "y": 24, "w": 28, "h": 18, "rot": 0, "label": "Последняя Трапеза"}, {"type": "arrow", "x": 50, "y": 56, "w": 18, "h": 5, "rot": 180, "label": "Дожим / бурст"}]}], "altar": [{"name": "Фаза 1 — Зул’джан", "note": "Босс у верхней части комнаты. Танк направляет Рассечение через нужные сгустки, а не по рейду.", "duration": 10, "tokens": [["boss", "ЗУЛ’ДЖАН", "boss", 50, 24], ["t1", "T1", "tank", 50, 36], ["t2", "T2", "tank", 42, 34], ["h1", "H1", "healer", 34, 70], ["h2", "H2", "healer", 50, 74], ["h3", "H3", "healer", 66, 70], ["m1", "M1", "melee", 46, 30], ["m2", "M2", "melee", 54, 30], ["r1", "R1", "ranged", 30, 56], ["r2", "R2", "ranged", 70, 56], ["r3", "R3", "ranged", 50, 56], ["orb1", "СГУСТОК", "marker", 32, 46], ["orb2", "СГУСТОК", "marker", 68, 46], ["orb3", "СГУСТОК", "marker", 50, 58]], "effects": [{"type": "line", "x": 40, "y": 40, "w": 20, "h": 4, "rot": -25, "label": "Рассечение"}, {"type": "line", "x": 60, "y": 40, "w": 20, "h": 4, "rot": 25, "label": "Рассечение"}, {"type": "zone", "x": 50, "y": 58, "w": 14, "h": 14, "rot": 0, "label": "Не взрывать всё сразу"}]}, {"name": "Рассечение через сгустки", "note": "Танк уводит босса так, чтобы срезать только нужные сгустки. Рейд стоит на противоположной половине.", "duration": 9, "tokens": [["boss", "ЗУЛ’ДЖАН", "boss", 38, 28], ["t1", "T1", "tank", 30, 34], ["t2", "T2", "tank", 44, 34], ["h1", "H1", "healer", 60, 72], ["h2", "H2", "healer", 70, 68], ["h3", "H3", "healer", 50, 74], ["m1", "M1", "melee", 38, 34], ["m2", "M2", "melee", 44, 28], ["r1", "R1", "ranged", 62, 56], ["r2", "R2", "ranged", 74, 54], ["r3", "R3", "ranged", 52, 58], ["orb1", "СГУСТОК", "marker", 32, 46], ["orb2", "СГУСТОК", "marker", 68, 46], ["orb3", "СГУСТОК", "marker", 50, 58]], "effects": [{"type": "line", "x": 34, "y": 38, "w": 26, "h": 4, "rot": -50, "label": "Танковое рассечение"}, {"type": "zone", "x": 66, "y": 58, "w": 26, "h": 16, "rot": 0, "label": "Рейд стоит здесь"}]}, {"name": "Фаза 2 — Малакрасс", "note": "В центре появляется Малакрасс. Проявления ужаса вытаскиваются под танковый удар и быстро добиваются.", "duration": 10, "tokens": [["boss", "МАЛАКРАСС", "boss", 50, 24], ["t1", "T1", "tank", 50, 36], ["t2", "T2", "tank", 42, 34], ["h1", "H1", "healer", 34, 70], ["h2", "H2", "healer", 50, 74], ["h3", "H3", "healer", 66, 70], ["m1", "M1", "melee", 46, 30], ["m2", "M2", "melee", 54, 30], ["r1", "R1", "ranged", 30, 56], ["r2", "R2", "ranged", 70, 56], ["r3", "R3", "ranged", 50, 56], ["horrorL", "УЖАС", "marker", 28, 44], ["horrorR", "УЖАС", "marker", 72, 44]], "effects": [{"type": "line", "x": 38, "y": 38, "w": 20, "h": 4, "rot": -35, "label": "Soul Sever"}, {"type": "line", "x": 62, "y": 38, "w": 20, "h": 4, "rot": 35, "label": "Soul Sever"}, {"type": "arrow", "x": 50, "y": 56, "w": 26, "h": 5, "rot": 180, "label": "ДД добивают ужасы"}]}, {"name": "Вечный сумрак — быстрый свитч", "note": "Если появляется щит сумрака, весь фокус уходит в него. Рейд играет компактно, чтобы быстрее продолжить фазу.", "duration": 8, "tokens": [["boss", "МАЛАКРАСС", "boss", 50, 24], ["t1", "T1", "tank", 50, 36], ["t2", "T2", "tank", 42, 34], ["h1", "H1", "healer", 40, 66], ["h2", "H2", "healer", 50, 68], ["h3", "H3", "healer", 60, 66], ["m1", "M1", "melee", 46, 30], ["m2", "M2", "melee", 54, 30], ["r1", "R1", "ranged", 40, 56], ["r2", "R2", "ranged", 60, 56], ["r3", "R3", "ranged", 50, 56], ["shield", "ЩИТ", "marker", 50, 44]], "effects": [{"type": "soak", "x": 50, "y": 60, "w": 24, "h": 14, "rot": 0, "label": "Компактный рейд"}, {"type": "zone", "x": 50, "y": 44, "w": 20, "h": 20, "rot": 0, "label": "Приоритетный щит"}]}, {"name": "Фаза 3 — оба босса", "note": "Собирается финальное наложение механик. Рейд играет в нижней половине комнаты, оставляя танкам простор сверху.", "duration": 12, "tokens": [["boss1", "ЗУЛ’ДЖАН", "boss", 40, 22], ["boss2", "МАЛАКРАСС", "boss", 60, 22], ["t1", "T1", "tank", 44, 34], ["t2", "T2", "tank", 56, 34], ["h1", "H1", "healer", 36, 70], ["h2", "H2", "healer", 50, 74], ["h3", "H3", "healer", 64, 70], ["m1", "M1", "melee", 46, 30], ["m2", "M2", "melee", 54, 30], ["r1", "R1", "ranged", 34, 56], ["r2", "R2", "ranged", 66, 56], ["r3", "R3", "ranged", 50, 58]], "effects": [{"type": "zone", "x": 50, "y": 58, "w": 34, "h": 20, "rot": 0, "label": "Рейдовая позиция"}, {"type": "cone", "x": 44, "y": 30, "w": 18, "h": 16, "rot": 180, "label": "Танк 1"}, {"type": "cone", "x": 56, "y": 30, "w": 18, "h": 16, "rot": 180, "label": "Танк 2"}]}, {"name": "Финальный оверлап — дожим", "note": "Безопасное пространство уже ограничено. Последние рейдовые КД идут по расписанию, боссов добиваем в центре.", "duration": 14, "tokens": [["boss1", "ЗУЛ’ДЖАН", "boss", 44, 24], ["boss2", "МАЛАКРАСС", "boss", 56, 24], ["t1", "T1", "tank", 46, 36], ["t2", "T2", "tank", 54, 36], ["h1", "H1", "healer", 40, 66], ["h2", "H2", "healer", 50, 68], ["h3", "H3", "healer", 60, 66], ["m1", "M1", "melee", 46, 30], ["m2", "M2", "melee", 54, 30], ["r1", "R1", "ranged", 40, 56], ["r2", "R2", "ranged", 60, 56], ["r3", "R3", "ranged", 50, 56]], "effects": [{"type": "zone", "x": 30, "y": 48, "w": 18, "h": 18, "rot": 0, "label": "Опасная часть"}, {"type": "zone", "x": 70, "y": 48, "w": 18, "h": 18, "rot": 0, "label": "Опасная часть"}, {"type": "soak", "x": 50, "y": 60, "w": 28, "h": 16, "rot": 0, "label": "Последний компакт"}, {"type": "arrow", "x": 50, "y": 56, "w": 18, "h": 5, "rot": 180, "label": "Добить"}]}], "ulatek": [{"name": "Пулл — яйца и волны", "note": "Босс в центре. Яйца по периметру нельзя задевать лишними волнами. РДД и хилы играют снизу полукругом.", "duration": 10, "tokens": [["boss", "УЛА’ТЕК", "boss", 50, 48], ["t1", "T1", "tank", 50, 34], ["t2", "T2", "tank", 42, 38], ["h1", "H1", "healer", 34, 72], ["h2", "H2", "healer", 50, 76], ["h3", "H3", "healer", 66, 72], ["m1", "M1", "melee", 46, 54], ["m2", "M2", "melee", 54, 54], ["r1", "R1", "ranged", 30, 62], ["r2", "R2", "ranged", 70, 62], ["r3", "R3", "ranged", 50, 62], ["egg1", "ЯЙЦО", "marker", 20, 22], ["egg2", "ЯЙЦО", "marker", 80, 22], ["egg3", "ЯЙЦО", "marker", 20, 78], ["egg4", "ЯЙЦО", "marker", 80, 78]], "effects": [{"type": "line", "x": 50, "y": 62, "w": 46, "h": 4, "rot": 0, "label": "РДД / хилы"}, {"type": "zone", "x": 20, "y": 22, "w": 14, "h": 14, "rot": 0, "label": "Яйцо"}, {"type": "zone", "x": 80, "y": 22, "w": 14, "h": 14, "rot": 0, "label": "Яйцо"}, {"type": "zone", "x": 20, "y": 78, "w": 14, "h": 14, "rot": 0, "label": "Яйцо"}, {"type": "zone", "x": 80, "y": 78, "w": 14, "h": 14, "rot": 0, "label": "Яйцо"}]}, {"name": "Едкие волны — увод по часовой", "note": "При волнах рейд смещается по внешней дуге и сохраняет между волной и яйцами чистый коридор.", "duration": 10, "tokens": [["boss", "УЛА’ТЕК", "boss", 50, 48], ["t1", "T1", "tank", 50, 34], ["t2", "T2", "tank", 42, 38], ["h1", "H1", "healer", 58, 74], ["h2", "H2", "healer", 68, 70], ["h3", "H3", "healer", 74, 62], ["m1", "M1", "melee", 52, 56], ["m2", "M2", "melee", 58, 54], ["r1", "R1", "ranged", 58, 82], ["r2", "R2", "ranged", 72, 78], ["r3", "R3", "ranged", 80, 68], ["egg1", "ЯЙЦО", "marker", 20, 22], ["egg2", "ЯЙЦО", "marker", 80, 22], ["egg3", "ЯЙЦО", "marker", 20, 78], ["egg4", "ЯЙЦО", "marker", 80, 78]], "effects": [{"type": "arrow", "x": 62, "y": 70, "w": 54, "h": 7, "rot": 30, "label": "Путь волны / движение"}, {"type": "zone", "x": 80, "y": 22, "w": 14, "h": 14, "rot": 0, "label": "Не задеть яйцо"}, {"type": "zone", "x": 80, "y": 78, "w": 14, "h": 14, "rot": 0, "label": "Не задеть яйцо"}], "routes": {"h1": [{"x": 42, "y": 76}, {"x": 50, "y": 78}], "h2": [{"x": 54, "y": 76}, {"x": 62, "y": 74}], "h3": [{"x": 66, "y": 72}, {"x": 72, "y": 68}], "r1": [{"x": 42, "y": 66}, {"x": 56, "y": 76}], "r2": [{"x": 58, "y": 72}, {"x": 68, "y": 76}], "r3": [{"x": 68, "y": 70}, {"x": 76, "y": 70}]}}, {"name": "Спектральные кольца — общий soak", "note": "На кольца весь рейд быстро возвращается в центр и закрывает общий soak. Сразу после — расход назад к безопасной дуге.", "duration": 9, "tokens": [["boss", "УЛА’ТЕК", "boss", 50, 48], ["t1", "T1", "tank", 50, 34], ["t2", "T2", "tank", 42, 38], ["h1", "H1", "healer", 42, 56], ["h2", "H2", "healer", 50, 58], ["h3", "H3", "healer", 58, 56], ["m1", "M1", "melee", 46, 52], ["m2", "M2", "melee", 54, 52], ["r1", "R1", "ranged", 42, 64], ["r2", "R2", "ranged", 58, 64], ["r3", "R3", "ranged", 50, 66]], "effects": [{"type": "soak", "x": 50, "y": 58, "w": 30, "h": 28, "rot": 0, "label": "Спектральные кольца — ВСЕ"}, {"type": "arrow", "x": 50, "y": 66, "w": 18, "h": 5, "rot": 180, "label": "Собраться"}]}, {"name": "Ядовитое сердце — бурст окно", "note": "Короткое окно повышенного урона по боссу. Рейд играет компактно справа от центра, освобождая путь следующей волне.", "duration": 8, "tokens": [["boss", "УЛА’ТЕК", "boss", 56, 46], ["t1", "T1", "tank", 56, 34], ["t2", "T2", "tank", 48, 38], ["h1", "H1", "healer", 40, 60], ["h2", "H2", "healer", 50, 62], ["h3", "H3", "healer", 60, 60], ["m1", "M1", "melee", 52, 50], ["m2", "M2", "melee", 60, 50], ["r1", "R1", "ranged", 40, 70], ["r2", "R2", "ranged", 54, 70], ["r3", "R3", "ranged", 66, 68]], "effects": [{"type": "zone", "x": 56, "y": 46, "w": 22, "h": 22, "rot": 0, "label": "Окно бурста"}, {"type": "arrow", "x": 56, "y": 58, "w": 18, "h": 5, "rot": 180, "label": "Бурст / короткий дожим"}]}, {"name": "Интермиссия — стражи чешуи", "note": "Из яиц выходят стражи. РДД и танки перехватывают их у краёв, не давая активировать лишние яйца.", "duration": 10, "tokens": [["boss", "УЛА’ТЕК", "boss", 50, 48], ["t1", "T1", "tank", 24, 24], ["t2", "T2", "tank", 76, 24], ["h1", "H1", "healer", 34, 72], ["h2", "H2", "healer", 50, 76], ["h3", "H3", "healer", 66, 72], ["m1", "M1", "melee", 34, 24], ["m2", "M2", "melee", 66, 24], ["r1", "R1", "ranged", 20, 34], ["r2", "R2", "ranged", 80, 34], ["r3", "R3", "ranged", 50, 62], ["add1", "СТРАЖ", "marker", 20, 22], ["add2", "СТРАЖ", "marker", 80, 22]], "effects": [{"type": "arrow", "x": 24, "y": 28, "w": 16, "h": 5, "rot": -90, "label": "Свитч"}, {"type": "arrow", "x": 76, "y": 28, "w": 16, "h": 5, "rot": -90, "label": "Свитч"}, {"type": "line", "x": 50, "y": 62, "w": 40, "h": 4, "rot": 0, "label": "Хилы / РДД внизу"}]}, {"name": "Возврат босса — вторая волна", "note": "После интермиссии снова играем по кругу, сохраняя правый сектор как основной безопасный.", "duration": 10, "tokens": [["boss", "УЛА’ТЕК", "boss", 56, 48], ["t1", "T1", "tank", 56, 34], ["t2", "T2", "tank", 48, 38], ["h1", "H1", "healer", 42, 68], ["h2", "H2", "healer", 54, 70], ["h3", "H3", "healer", 66, 68], ["m1", "M1", "melee", 52, 54], ["m2", "M2", "melee", 60, 54], ["r1", "R1", "ranged", 44, 78], ["r2", "R2", "ranged", 58, 80], ["r3", "R3", "ranged", 72, 74]], "effects": [{"type": "arrow", "x": 58, "y": 72, "w": 40, "h": 7, "rot": 20, "label": "Волна / путь рейда"}, {"type": "zone", "x": 80, "y": 78, "w": 14, "h": 14, "rot": 0, "label": "Сохраняем яйцо"}]}, {"name": "Фаза 3 — сужение арены", "note": "Арена разрушена. Рейд заранее уходит в оставшийся правый безопасный сектор и играет очень компактно.", "duration": 12, "tokens": [["boss", "УЛА’ТЕК", "boss", 70, 44], ["t1", "T1", "tank", 72, 30], ["t2", "T2", "tank", 62, 34], ["h1", "H1", "healer", 80, 62], ["h2", "H2", "healer", 72, 66], ["h3", "H3", "healer", 64, 62], ["m1", "M1", "melee", 66, 48], ["m2", "M2", "melee", 74, 48], ["r1", "R1", "ranged", 84, 74], ["r2", "R2", "ranged", 72, 76], ["r3", "R3", "ranged", 60, 74], ["safe", "SAFE", "marker", 78, 52]], "effects": [{"type": "zone", "x": 28, "y": 52, "w": 56, "h": 84, "rot": 0, "label": "Разрушенная зона"}, {"type": "soak", "x": 72, "y": 64, "w": 28, "h": 20, "rot": 0, "label": "Оставшийся safe-сектор"}, {"type": "arrow", "x": 72, "y": 56, "w": 22, "h": 5, "rot": 180, "label": "Собраться сюда"}]}, {"name": "Финальный дожим на P3", "note": "Героизм, личные и последние рейдовые КД. Босс добивается внутри оставшегося безопасного кармана.", "duration": 14, "tokens": [["boss", "УЛА’ТЕК", "boss", 74, 42], ["t1", "T1", "tank", 76, 30], ["t2", "T2", "tank", 66, 34], ["h1", "H1", "healer", 82, 60], ["h2", "H2", "healer", 74, 64], ["h3", "H3", "healer", 66, 60], ["m1", "M1", "melee", 70, 46], ["m2", "M2", "melee", 78, 46], ["r1", "R1", "ranged", 84, 72], ["r2", "R2", "ranged", 74, 74], ["r3", "R3", "ranged", 64, 72], ["safe", "SAFE", "marker", 78, 52]], "effects": [{"type": "zone", "x": 28, "y": 52, "w": 56, "h": 84, "rot": 0, "label": "Разрушенная зона"}, {"type": "soak", "x": 74, "y": 62, "w": 30, "h": 22, "rot": 0, "label": "Весь рейд в safe-секторе"}, {"type": "arrow", "x": 74, "y": 56, "w": 24, "h": 5, "rot": 180, "label": "Героизм / дожим"}]}]};
