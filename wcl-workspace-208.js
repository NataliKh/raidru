...
(() => {
  ...
  const oldRender208=render;render=function(){oldRender208();decorateWclWorkspace208();const version=document.querySelector('aside .version');if(version)version.textContent='RaidRU 2.2.1 · WCL Bridge Final Audit'};
