...
ok(html.includes('viewer-212.js?v=2.2.1-wcl-bridge-final-audit'), 'viewer script not loaded');
ok(html.includes('navigation-211.js?v=2.1.1-navigation'), 'navigation script missing from page');
ok((sw.includes("raidru-v213-neutral-roles")||sw.includes("raidru-v214-wcl-fight-scope")||sw.includes("raidru-v215-wcl-full-event-replay")||sw.includes("raidru-v221-wcl-bridge-final-audit")), 'service worker cache version not bumped');
