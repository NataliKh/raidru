...
ok(html.includes('viewer-212.js?v=2.2.0-wcl-hybrid-bridge'), 'viewer script not loaded');
ok(html.includes('navigation-211.js?v=2.1.1-navigation'), 'navigation script missing from page');
ok((sw.includes("raidru-v213-neutral-roles")||sw.includes("raidru-v214-wcl-fight-scope")||sw.includes("raidru-v215-wcl-full-event-replay")||sw.includes("raidru-v220-wcl-hybrid-bridge")), 'service worker cache version not bumped');
