 ...
 */
(() => {
  const VERSION='2.1.4-fight-scope';
  ...
  render=function(){coreRender200();decorateReplay200();const version=document.querySelector('aside .version');if(version)version.textContent='RaidRU 2.1.4 · WCL Fight Scope'};
