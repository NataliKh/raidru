 ...
 */
(() => {
  const VERSION='2.0.5-wcl-one-shot';
  ...
  render=function(){coreRender200();decorateReplay200();const version=document.querySelector('aside .version');if(version)version.textContent='RaidRU 2.0.5 preview · WCL One-Shot'};
