...
ok(/styles\.css\?v=(2\.1\.(0-performance|1-navigation|3-neutral-roles|4-wcl-fight-scope|5-wcl-full-event-replay))/.test(html),'styles cache bust missing');
ok(html.includes('wcl-mechanics-209.js?v=2.1.0-performance'),'mechanics cache bust missing');
ok(/raidru-v(210-performance-core|211-navigation|213-neutral-roles|214-wcl-fight-scope|215-wcl-full-event-replay)/.test(sw),'service worker cache bump missing');
