...
ok(html.includes('styles.css?v=2.2.0-wcl-hybrid-bridge'),'styles cache bust missing');
ok(html.includes('wcl-mechanics-209.js?v=2.1.0-performance'),'mechanics cache bust missing');
ok(/raidru-v(210-performance-core|211-navigation|213-neutral-roles|214-wcl-fight-scope|215-wcl-full-event-replay|216-wcl-replaysegment-core|218-wcl-graphql-resource-replay|220-wcl-hybrid-bridge)/.test(sw),'service worker cache bump missing');
ok(js.includes('MECHANICS ANALYSIS · 2.2.0'),'visible mechanics version not bumped');
