...
ok(html.includes('styles.css?v=2.1.0-performance'),'styles cache bust missing');
ok(html.includes('wcl-mechanics-209.js?v=2.1.0-performance'),'mechanics cache bust missing');
ok(sw.includes("raidru-v210-performance-core"),'service worker cache bump missing');
