...
ok(html.includes('app.js?v=2.1.8-wcl-graphql-resource-replay'), 'app cache bust missing');
ok((sw.includes("raidru-v213-neutral-roles")||sw.includes("raidru-v214-wcl-fight-scope")||sw.includes("raidru-v215-wcl-full-event-replay")||sw.includes("raidru-v218-wcl-graphql-resource-replay")), 'service worker cache not bumped');
