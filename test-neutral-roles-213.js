...
ok(html.includes('app.js?v=2.1.7-wcl-replay-boss-resolver'), 'app cache bust missing');
ok((sw.includes("raidru-v213-neutral-roles")||sw.includes("raidru-v214-wcl-fight-scope")||sw.includes("raidru-v215-wcl-full-event-replay")||sw.includes("raidru-v217-wcl-replay-boss-resolver")), 'service worker cache not bumped');
