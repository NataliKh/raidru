...
ok(/raidru-v(208-wcl-workspace|209-mechanics-analysis|210-performance-core|211-mechanics-readability|211-navigation|213-neutral-roles)/.test(sw)&&/wcl-workspace-208\.js\?v=(2\.0\.(8-wcl-workspace|9-mechanics)|2\.1\.0-performance)/.test(sw),'service worker cache missing');
