...
const checks=[
 ['ui script loaded',html.includes('ui-101.js?v=2.1.3-neutral-roles')],
 ['current cache',/raidru-v(207-wcl-coordinates|208-wcl-workspace|209-mechanics-analysis|210-performance-core|211-mechanics-readability|211-navigation|212-plan-viewer|213-neutral-roles)/.test(sw)&&sw.includes("'./ui-101.js?v=2.1.3-neutral-roles'")&&/wcl-safe-200\.js\?v=(2\.0\.(7-wcl-coordinates|8-wcl-workspace|9-mechanics)|2\.1\.0-performance)/.test(sw)],
