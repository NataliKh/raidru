...
ok(!/events\(dataType: (?:Casts|Debuffs|Summons), hostilityType:/.test(worker),'mechanics query must not depend on HostilityType filters; friendliness is filtered from event flags/roster');
