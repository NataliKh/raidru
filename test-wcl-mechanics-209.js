...
ok(/raidru-v(209-mechanics-analysis|210-performance-core|211-mechanics-readability|211-navigation|213-neutral-roles)/.test(sw)&&/wcl-mechanics-209\.js\?v=(2\.0\.(9-mechanics|11-readability)|2\.1\.0-performance)/.test(sw),'SW cache not bumped');
