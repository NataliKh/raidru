...
if(!html.includes('styles.css?v=2.1.4-wcl-fight-scope'))throw new Error('css bust missing');
if(!(sw.includes("raidru-v213-neutral-roles")||sw.includes("raidru-v214-wcl-fight-scope"))||!sw.includes('navigation-211.js?v=2.1.1-navigation'))throw new Error('service worker bust missing');
