...
if(!html.includes('styles.css?v=2.2.1-wcl-bridge-final-audit'))throw new Error('css bust missing');
if(!(sw.includes("raidru-v213-neutral-roles")||sw.includes("raidru-v214-wcl-fight-scope")||sw.includes("raidru-v215-wcl-full-event-replay")||sw.includes("raidru-v221-wcl-bridge-final-audit"))||!sw.includes('navigation-211.js?v=2.1.1-navigation'))throw new Error('service worker bust missing');
