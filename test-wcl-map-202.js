...
assert(/app\.js\?v=(2\.0\.(7-wcl-coordinates|9-mechanics)|2\.1\.(0-performance|3-neutral-roles|4-wcl-fight-scope))/.test(html)&&/wcl-safe-200\.js\?v=(2\.0\.(7-wcl-coordinates|9-mechanics)|2\.1\.(0-performance|4-wcl-fight-scope))/.test(html),'cache bust missing');
assert(/raidru-v(207-wcl-coordinates|209-mechanics-analysis|210-performance-core|211-mechanics-readability|211-navigation|213-neutral-roles|214-wcl-fight-scope)/.test(sw),'service worker version missing');
